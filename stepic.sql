...
INSERT INTO `knigi` VALUES (1,'Мастер и Маргарита',' Булгаков М.А.',671.00,3),(2,'Мастер и Маргарита',' Булгаков М.А.',671.00,3),(3,'Белая гвардия',' Булгаков М.А.',540.50,5),(4,'Идиот',' Достоевский Ф.М.',460.00,10),(5,'Братья Карамазовы',' Достоевский Ф.М.',799.01,2),(6,'Стихотворения и поэмы',' Есенин С.А.',650.00,15),(7,'Черный человек','Есенин С.А.',NULL,NULL);
...
-- Dump completed on 2022-11-01 10:32:56
